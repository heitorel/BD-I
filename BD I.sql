...
ALTER TABLE ORGANIZACAO_MEDIADORA ADD CONSTRAINT fk_ID_Grupo  FOREIGN KEY (ID_Grupo) REFERENCES GRUPO(ID_Grupo);
...
ALTER TABLE CONFLITO ADD CONSTRAINT fk_ID_Grupo_i  FOREIGN KEY (ID_Grupo) REFERENCES GRUPO(ID_Grupo);
