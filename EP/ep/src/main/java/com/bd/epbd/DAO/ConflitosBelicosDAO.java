...
public class ConflitosBelicosDAO {
    ...
    public void CadastraConflito(Integer id, Integer mortos, Integer feridos, String tipo, Integer idGrupo,
        ...
        ConflitoBelico conflitoBelico = new ConflitoBelico(id,mortos,feridos,idGrupo,
                flag_territorial, flag_religioso, flag_economico, flag_racial);
        ...
        try{
            ...
            stmt.setInt(5, conflitoBelico.getFlag_territorial());
            stmt.setInt(6, conflitoBelico.getFlag_religioso());
            stmt.setInt(7, conflitoBelico.getFlag_economico());
            stmt.setInt(8, conflitoBelico.getFlag_racial());
